...
void ADC_fileter_init(void)
{
  init_circular_list(adc_sensor.adc_filter_c, ADCC_FILTER_NUM, v_next);
  init_circular_list(adc_sensor.adc_filter_c, ADCC_CH_NUM, p_next);
}

uint16_t* _ADCP_start_sample(void)				//�ô���Ҫ�Ż�����ֹwhile�ȴ�ʱ��������Ӱ������Ч��
{
